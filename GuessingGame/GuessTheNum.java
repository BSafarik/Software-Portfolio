/* This program is a guessing game to where users have 10 guess to figure out the randomly selected number
   between 1 and 100. After a user guesses, it then tells the user to whether their guess was too low or too high */
...
public class GuessTheNum {
	...
	public static JButton replayButton;
		...
		public static void main(String arg[]) {
			...
			// Sets up the gui frame for the game
			frame = new JFrame();
			...
			submitGuess = new JButton(new AbstractAction("Submit Guess") {
				...
				public void actionPerformed(ActionEvent e) {	
					...
					// This conditional continues being tested as long as the user has guess remaining
					if(guessAmount >= 0) {
						...
						// Is true if user guesses the correct number
						if (num == random) {
						...
						// Is true if the user guesses the incorrect number on their last guess
						if (guessAmount == 1) {
						...
						// Is true if the user guesses lower than the generated number
						else if (num < random) {
						...
						// Is true if the user guesses higher than the generated number
						else if (num > random) {
